...
Q2=zeros(p.a,p.b,p.A);% initialize for secondary tasj=k
...
for i=1:p.N_iter
    ...
    [Q,Q2,t_c,t_v,targ_pols,virt_pol_log,targ_pol_ret]=Q_learn(Q,Q2,t_c,t_v,targ_pols,targ_pol_ret,p);%q learning
    virt_pol_log_all{i}=virt_pol_log;%log the virtual policies
    avgreturns(i)=calcret(Q2,p,p.target2);%evaluate secondary task Q table
end
